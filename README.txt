...
a persistence unit "EvaluacionWSBarzalloPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSBarzallo\pom.xml":
...
artifact ("EvaluacionWSBarzallo.war") is already built. You can build
